...
namespace API_Tecnicaturas_UTN.Controllers
{
    ...
    public class TecnicaturasController : ControllerBase
    {
        ...
        [HttpGet("/tecnicaturas/proxima")]
        public IActionResult GetProximaTecnicatura()
        {
            int prox;
            try
            {
                prox = dataApi.GetProximaTecnicatura();
                return Ok(prox);
        ...
        public IActionResult BajaTecnicatura(Tecnicatura tec)
        {
            ...
            try
            {
                ...
                else result = Ok(dataApi.AltaBajaTecnicatura(tec,0));
                return result;
            }
            catch (Exception)
            {
        ...
        [HttpPut("/tecnicaturas/darAlta")]
        public IActionResult AltaTecnicatura(Tecnicatura tec)
        {
            IActionResult result;
            try
            {
                ...
                else result = Ok(dataApi.AltaBajaTecnicatura(tec, 1));
                return result;
            }
            catch (Exception)
            {
